...
select CountryCode,Language,IsOfficial,Percentaje from countrylanguage
  where Language like "%French%" and Percentaje >= 2 and Percentaje < 40 and IsOfficial= "true" ;
